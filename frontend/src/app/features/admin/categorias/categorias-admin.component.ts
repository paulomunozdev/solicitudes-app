...
@Component({
  ...
  styles: [`
    ...
    .cat-badge { display: inline-flex; align-items: center; height: 22px; padding: 0 10px; border-radius: 9999px; font-size: 12.5px; font-weight: 500; }
    .color-swatch { width: 20px; height: 20px; border-radius: 5px; display: inline-block; border: 1px solid rgba(0,0,0,0.08); }

    .status-badge { display: inline-flex; align-items: center; height: 22px; padding: 0 9px; border-radius: 9999px; font-size: 12px; font-weight: 500; background: var(--n-75, #f1f3f7); color: var(--n-600, #4e566a); }
    .status-badge--activo { background: oklch(0.96 0.035 155); color: oklch(0.42 0.120 155); }
